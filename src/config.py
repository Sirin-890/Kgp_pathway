...
open science. Please assign a score out of 100 percent ndicating the likelihood of acceptance for publication in the TMLR conference.'''
...
AI and machine learning applications in big data and its adherence to ethical and responsible data usage principles. Provide a score out of 100 percent indicating the likelihood of the context being accepted for publication in the KDD conference.'''
MODEL='GPT-4o mini'